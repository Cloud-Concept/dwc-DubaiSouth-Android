...
//Filling UI Fields
        ...
        tvValue.setText(activity.getVisa().getCountry_of_Birth__r() == null ? "" : activity.getVisa().getCountry_of_Birth__r().getName());
        nocDetails.addView(view);
        view = inflater.inflate(R.layout.wizards_form_field_details, null, false);
        tvLabel = (TextView) view.findViewById(R.id.pay_title);
        tvValue = (TextView) view.findViewById(R.id.pay_text);
        ...
        tvValue.setText(activity.getVisa().getCurrent_Nationality__r() == null ? "" : activity.getVisa().getCurrent_Nationality__r().getName());
        nocDetails.addView(view);
        view = inflater.inflate(R.layout.wizards_form_field_details, null, false);
        tvLabel = (TextView) view.findViewById(R.id.pay_title);
        tvValue = (TextView) view.findViewById(R.id.pay_text);
        tvLabel.setText("Previous nationality" + "\t:");
        tvValue.setText(activity.getVisa().getPrevious_Nationality__r() == null ? "" : activity.getVisa().getPrevious_Nationality__r().getName());
        nocDetails.addView(view);
        view = inflater.inflate(R.layout.wizards_form_field_details, null, false);
        tvLabel = (TextView) view.findViewById(R.id.pay_title);
        tvValue = (TextView) view.findViewById(R.id.pay_text);
        ...
        tvValue.setText(activity.getVisa().getPassport_Issue_Country__r() == null ? "" : activity.getVisa().getPassport_Issue_Country__r().getName());
        nocDetails.addView(view);
        view = inflater.inflate(R.layout.wizards_form_field_details, null, false);
        tvLabel = (TextView) view.findViewById(R.id.pay_title);
        tvValue = (TextView) view.findViewById(R.id.pay_text);
        ...
        tvValue.setText(activity.getVisa().getJob_Title_at_Immigration__r() == null ? "" : activity.getVisa().getJob_Title_at_Immigration__r().getName());
        nocDetails.addView(view);
        view = inflater.inflate(R.layout.wizards_form_field_details, null, false);
        tvLabel = (TextView) view.findViewById(R.id.pay_title);
        tvValue = (TextView) view.findViewById(R.id.pay_text);
        tvLabel.setText("Qualification" + "\t:");
        tvValue.setText(activity.getVisa().getQualification__r()==null?"":activity.getVisa().getQualification__r().getName());
        nocDetails.addView(view);
